...
public class JDlgConsultaCliente extends javax.swing.JDialog {
     ...
     */
    BcmConsultaClientesControler bcmConsultaClientesControler = new BcmConsultaClientesControler();
    ...
    public JDlgConsultaCliente(java.awt.Frame parent, boolean modal) {
        ...
        bcmConsultaClientesControler.setLista((List<BcmCliente>) clientesDAO.listAll());
        jTable1.setModel(bcmConsultaClientesControler);
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        // TODO add your handling code here:
        ClienteDAO clientesDAO = new ClienteDAO();
        List<BcmCliente> lista;  // Especificar o tipo genérico
        ...
        try {
            if (!cpf.isEmpty() && !cpf.equals(".   .   -")) {
                ...
                if (!nome.isEmpty()) {
                    lista = (List<BcmCliente>) clientesDAO.listNomeCpf(nome, cpf);
                } else {
                    lista = (List<BcmCliente>) clientesDAO.listCpf(cpf);
                }
            } else if (!nome.isEmpty()) {
                lista = (List<BcmCliente>) clientesDAO.listNome(nome);
            } else {
                lista = (List<BcmCliente>) clientesDAO.listAll();
            }
            
            if (lista != null && !lista.isEmpty()) {
                Object primeiroItem = lista.get(0);
                if (!(primeiroItem instanceof BcmCliente)) {
                    Util.mostrar(
            ...
            bcmConsultaClientesControler.setLista(lista);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgConsultaCliente.class
